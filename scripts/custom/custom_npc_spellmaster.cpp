...
bool GossipHello_custom_npc_spellmaster(Player* pPlayer, Creature* pCreature)
{
    ...
    bool LearnAllLanguages          = DARKICEConfig.GetBoolDefault("Spellmaster.LearnAllLanguages", true);
    ...
    bool MaxOutLanguageSkills       = DARKICEConfig.GetBoolDefault("Spellmaster.MaxOutAllLanguageSkills", true);
...
case 11000: // Weapon Skills
    ...
    pPlayer->CLOSE_GOSSIP_MENU();
    pCreature->MonsterWhisper(MSG_LEARNED_WEAPON, pPlayer->GetGUID());
...
case 14000: // Learn all languages
    ...
    pPlayer->CLOSE_GOSSIP_MENU();
    pCreature->MonsterWhisper(MSG_LEARNED_LANGUAGES, pPlayer->GetGUID());
...
case 15000: // Max out all languages
    ...
    pPlayer->CLOSE_GOSSIP_MENU();
    pCreature->MonsterWhisper(MSG_MAXED_LANGUAGES, pPlayer->GetGUID());
